...
Router::add('^(?P<lang>[a-z]+)?/?blogs/?$', ['controller' => 'Blogs', 'action' => 'view']);
Router::add('^(?P<lang>[a-z]+)?/?blogs/(?P<slug>[a-z0-9-]+)/?$', ['controller' => 'Blog', 'action' => 'view']);
Router::add('^(?P<lang>[a-z]+)?/?reviews/?$', ['controller' => 'Reviews', 'action' => 'view']);
